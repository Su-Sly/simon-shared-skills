...
- 许可证：Apache-2.0
- 查证版本：v0.10.0（Release 发布于 2026-09-01）
...
- 2026-09-07 上游问题状态：路由专项评测 #166 仍开放；跨协议 `agent_judge` #104 仍开放；确定性断言增强 #165 已完成关闭；Codex JSONL 单行超过 1 MiB 静默截断 #172 已修复关闭。
...
4. 上游关闭或有效规避仍开放的 #166、#104，或当前评测需求不受它们影响。
